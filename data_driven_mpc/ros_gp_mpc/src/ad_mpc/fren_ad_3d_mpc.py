...
import numpy as np
from ad_mpc.fren_ad_3d_optimizer import Fren_AD3DOptimizer
...
class Fren_AD3DMPC:
    def __init__(self, my_ad, t_horizon=1.0, n_nodes=20, q_cost=None, r_cost=None,
        ...
        self.ad_opt = Fren_AD3DOptimizer(my_ad, t_horizon=t_horizon, n_nodes=n_nodes,
    ...
    def set_reference(self, x_reference, curv_ref, cdist_ref, u_reference=None, terminal_point = False):
        """
        ...
        if isinstance(x_reference[0], list) or terminal_point:
            ...
            return self.ad_opt.set_reference_state(x_reference, u_reference,curv_ref, cdist_ref)
        else:
            # Target state is a sequence
            return self.ad_opt.set_reference_trajectory(x_reference, u_reference,curv_ref, cdist_ref)
